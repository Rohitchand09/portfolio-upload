...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Rohit Chand
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">Logical and result-driven full stack developer dedicated to building and optimizing user-focused websites.</p>
